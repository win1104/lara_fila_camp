...
class CreateAssistant extends Command
{
    ...
    public function handle()
    {
        ...
        $assistant = OpenAI::assistants()->create([
            ...
            'instructions' => '你是一位根據文件內容提供協助的客服助理。請根據所提供的文件回答使用者的問題，並使用與使用者問題相同的語言作答，如為中文問題用中文回答；如為英文問題用英文回答，以此類推。如果文件中找不到相關資訊，請用對應語言回覆：「抱歉，我不清楚這個問題的答案。」',
            'model' => 'gpt-4o-mini',
        ]);
