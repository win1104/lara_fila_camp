...
<section class="text-gray-600 body-font">
    <div class="container mx-auto px-5 py-24">
        ...
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 flex gap-4">
                ...
                <img src="{{ Storage::url($images2) }}" class="object-cover object-center rounded w-1/2" alt="hero">
                <img src="{{ Storage::url($images3) }}" class="object-cover object-center rounded w-1/2" alt="hero">
                <img src="{{ Storage::url($images4) }}" class="object-cover object-center rounded w-1/2" alt="hero">
        </div>
    </div>
</section>
</div>
