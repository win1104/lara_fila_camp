<section class="" style="
    ...
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-wrap sm:flex-nowrap justify-center gap-8">
            ...
            <div class="">
                <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">{!! $title_r1 !!}</h2>
                <p class="leading-relaxed text-base">{!! $contact_r1 !!}</p>
                <div class="">
                    <img alt="content" class="object-cover object-center h-full w-full" src="{{ Storage::url($image_r) }}">
                </div>
                <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">{!! $title_r2 !!}</h2>
                <p class="leading-relaxed text-base">{!! $contact_r2 !!}</p>
            </div>
