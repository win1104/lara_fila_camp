<div>
    {{-- 首頁Banner --}}
    <div class="relative">
        <img src="{{ asset('banner01.png') }}" class="absolute inset-0 object-cover w-full h-full" alt="" />
        <div class="relative  bg-opacity-75">
            ...
            <div class="max-w-[1600px] mx-auto px-8 py-28 lg:px-32">
                ...
                <div class="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
                    <div class="flex flex-col justify-between py-6 px-8 border rounded-3xl shadow-[3px_6px_9px_rgb(0 0 0 / 16%)] h-60"
    ...
    <section class="text-gray-600 body-font">
        <div class="max-w-[1280px] px-5 py-24 mx-auto flex flex-wrap flex-col">
                        ...
                        <div class="w-full flex-shrink-0">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                @foreach($chunk as $post)
                                    <div class="p-2">
                                        <div
                                            class="h-full shadow-md border-2 border-gray-200 border-opacity-60 rounded-2xl overflow-hidden">
                                            <img class="h-72 w-full object-cover object-center"
                                                src="{{ $post->post_image ?? 'https://dummyimage.com/720x400' }}"
                                                alt="{{ $post->post_title }}">
                                            <div class="p-6">
                                                <p
                                                    class="border-gray-400 w-fit max-w-[74px] px-2 text-center border rounded-md tracking-widest text-sm title-font font-medium text-gray-400 mb-1">
                                                    {{ $post->post_tag }}</p>
                                                <h1 class="title-font text-lg font-extrabold text-gray-900 mt-3 mb-7">
                                                    {{ $post->post_title }}</h1>
                                                <div class="flex items-center flex-wrap">
                                                    <a href="{{ $post->post_url }}" target="{{ $post->post_url_target }}"
                                                        class="inline-flex items-center md:mb-2 lg:mb-0">
                                                        {{ $post->post_time ? date('Y-m-d', strtotime($post->post_time)) : '觀看網站 ➔' }}
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="flex flex-wrap -m-4 px-5">
                    ...
                    <div class="h-full shadow-md border-2 border-gray-200 border-opacity-60 rounded-2xl overflow-hidden">
                        ...
                        <div class="p-6">
                            <p
                                class="border-gray-400 text-center border rounded-md max-w-[46px] tracking-widest text-sm title-font font-medium text-gray-400 mb-1">
                                醫療</p>
                            <h1 class="title-font text-lg font-extrabold text-gray-900 mt-3 mb-7">網站 B</h1>
                            <div class="flex items-center flex-wrap">
                                <a class="inline-flex items-center md:mb-2 lg:mb-0">2024-03-27
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-2 md:w-1/3">
                    <div class="h-full shadow-md border-2 border-gray-200 border-opacity-60 rounded-2xl overflow-hidden">
                        <img class="h-72 w-full object-cover object-center" src="https://dummyimage.com/722x402" alt="blog">
                        <div class="p-6">
                            <p
                                class="border-gray-400 text-center border rounded-md max-w-[46px] tracking-widest text-sm title-font font-medium text-gray-400 mb-1">
                                科技</p>
                            <h1 class="title-font text-lg font-extrabold text-gray-900 mt-3 mb-7">網站 C</h1>
                            <div class="flex items-center flex-wrap ">
                                <a class="inline-flex items-center md:mb-2 lg:mb-0">2024-03-27
                                </a>
                            </div>
        ...
        <div class="max-w-[1600px] mx-auto px-8 py-20 lg:px-32">
            ...
            <div class="divide-y divide-gray-300 px-5">
                ...
                <div class="py-8 flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="md:flex-grow">
                        <h2 class="text-xl font-black text-gray-900 title-font mb-2">[資訊分享] 高雄市傳統彩繪（馮進興、張財雄）保存維護計畫</h2>
                ...
                <div class="py-8 flex flex-wrap md:flex-nowrap">
                    <div class="pl-8 md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                        <span class="font-semibold title-font text-gray-700 mt-1.5">112 年度</span>
                        <span
                            class="border-gray-400 text-center border rounded-md max-w-[46px] mt-4 text-sm text-gray-500">科技</span>
                    </div>
                    <div class="md:flex-grow">
                        <h2 class="text-xl font-black text-gray-900 title-font mb-2">本所退休之名譽教授林會承於台北國際書展之訪談新聞。</h2>
                        <p class="leading-relaxed">年齡與職業的標籤，限制不了你投入學習的實踐；空間與地域的限制，鎖不住你對未來的想像。</p>
